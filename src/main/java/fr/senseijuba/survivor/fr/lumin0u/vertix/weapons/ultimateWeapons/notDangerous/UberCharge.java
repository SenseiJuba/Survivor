				...
				public void run()
				{
					...
					if(i == 16)
					{
						...
						new BukkitRunnable()
						{
							...
							{
								try {
									if(isRegening.get(pl) || pl.isDead() || ((MedecinePortable)MedecinePortable.getInstance()).isRegening == null || ((MedecinePortable)MedecinePortable.getInstance()).isRegening.get(pl))
									{
										this.cancel();
										return;
									}
