...
{
	private static HashMap<Player, Boolean> isRegening = new HashMap<>();
	
	public UberCharge()
	{
		super("Uber Charge", Material.GLOWSTONE_DUST, 1, 1, true, "guns.remedy", 100, "�6Soigne tout les alli�s pendant 8s");
	}
					...
					if(i == 16)
					{
						...
						new BukkitRunnable()
						{
							...
							public void run()
							{
								...
								if(i == 100)
								{
									pl.setMaxHealth(PlayerManager.getInstance().kitOf(pl).getMaxHealth());
