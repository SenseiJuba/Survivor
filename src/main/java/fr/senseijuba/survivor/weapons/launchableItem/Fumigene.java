...
public class Fumigene extends AbstractLaunchableItem
{
	public Fumigene()
	{
		super("Fumig�ne", Material.NETHER_BRICK_ITEM, 1, 13.9, 1, false, "", 1, 50l, "�6Rayon de fum�e : �a5 blocs", "�6Recharge : �a14s");
	}
		...
		for(int x = 0; x < 11; x++)
		{
			for(int y = 0; y < 11; y++)
			{
				for(int z = 0; z < 11; z++)
				{
					...
					if(loc.distance(l) < 5.01 && loc.getBlock().getType().equals(Material.AIR))
					{
						fumiBlocks.add(loc);
					}
				}
