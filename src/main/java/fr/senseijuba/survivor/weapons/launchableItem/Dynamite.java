...
public class Dynamite extends AbstractLaunchableItem
{
	public Dynamite()
	{
		super("Dynamite", Material.CLAY_BRICK, 1, 7.9, 1, false, "", 1, 50l, "�6Degats : �a20", "�6Rayon : �a7 blocs", "�6Recharge : �a7s");
	}
	...
	public void explode(Location l, Player launcher)
	{
		...
		for(Player ent : l.getWorld().getPlayers())
		{
			...
			{
				GameManager.damageTF(ent, launcher, (rayonExplosion-ent.getLocation().distance(l))/rayonExplosion*damageExplosion, Utils.explosionVector(ent, l, rayonExplosion).multiply(valueKB));
