...
public class StartRailsCommand extends TfArgCommand
{
	public StartRailsCommand()
	{
		super("startRails", "définir le début du chemin rail d'une équipe en posant un rail dessus", "<T>", false, 1);
	}
	...
	public void execute(Player p, GameManager gm, String[] args)
	{
		...
		t.setStartRailsModifier(p);
		p.sendMessage("§7Posez un rail sur le début du chemin " + t.getName(false));
	}
