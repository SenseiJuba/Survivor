...
public enum Kit
{
	NOKIT(new AbstractWeapon[0], new Kukri(), 20, 0.2f, 1, 1, Material.BARRIER, 0, false, 0, 'a'),
	DEBUG(new AbstractWeapon[] {new MitrailletteLourde(), new Defoncator(), new Blaoups()}, new Striker(), 20, 0.2f, 1000, 20, Material.CARPET, 0, false, 0, 'z'),
